...
<body>
    <header class="px-16 py-4 bg-white flex flex-row gap-8 z-[999999] w-full justify-center items-center">
        <div>
    ...
    <section>
        <div class="flex flex-row min-h-screen">
            <div class="w-1/2 min-h-screen rolling-image-container">
                ...
                <div class="m-auto">
                    <div class="flex flex-col gap-8">
                        <div class="flex flex-col gap-4">
                            ...
                            <input name="u_email" id="u_email" type="text" placeholder="Masukan Email" class="rounded-sm px-4 py-2 w-[480px] border border-[#CACACA]">
                        </div>
                        <div class="flex flex-col gap-4">
                            <h2 class="text-black font-semibold text-xl">Password</h2> 
                            <input name="u_pass" id="u_pass" type="password" placeholder="Masukan Password" class="rounded-md px-4 py-2 w-[480px] border border-[#CACACA]">
                        </div>
                        <div class="flex flex-row justify-end gap-4">
                            <button type='submit' onclick="window.location.href='/.php'" class="bg-slate-400 hover:bg-slate-700 text-slate-200 font-semibold py-2 px-4 rounded transition ease-in-out">
                                <a>    
                                Daftar Akun
                                </a>
                            </button>
                            <button type='submit' class="bg-blue-900 hover:bg-[#14213D] text-white font-semibold py-2 px-4 rounded transition ease-in-out">
                                <a id="loginButton" >    
                                Masuk
                                </a>
                            </button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function loginUser() {
                ...
                var username = document.getElementById("u_email").value;

                // Check if the username is 'admin'
                if (username.toLowerCase() === 'admin') {
                    // Redirect to the admin page
                    window.location.href = '/produk-list';
                } else {
