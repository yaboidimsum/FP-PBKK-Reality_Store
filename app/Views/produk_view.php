...
<header>
  ...
  <div class="flex justify-end mb-2">
    <a href="<?= site_url('/produk-form') ?>" class="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded">Tambah Produk</a>
  </div>
  <?php
  ...
  ?>
  <div class="mt-3">
    <table class="table-auto w-full border border-collapse border-gray-400" id="produk-list">
      <thead>
        <tr>
      ...
      <tbody>
         ...
         <?php $nomor = 1 ?> 
          ...
          <td class="border p-2"><?php echo $nomor++; ?></td>
             <td class="border p-2"><?php echo $user['p_nama']; ?></td>
             <td class="border p-2"><?php echo $user['p_deskripsi']; ?></td>
             <td class="border p-2"><?php echo $user['p_warna']; ?></td>
             <td class="border p-2"><?php echo $user['p_ukuran']; ?></td>
             <td class="border p-2"><?php echo $user['p_harga']; ?></td>
             <td class="border p-2"><?php echo $user['p_gambar']; ?></td>
             <td class="border p-2">
             <div class="flex flex-row">
              <a href="<?php echo base_url('edit-produk/'.$user['p_id']);?>" class="bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded-sm text-sm">Edit</a>
              <a href="<?php echo base_url('delete-produk/'.$user['p_id']);?>" class="bg-red-500 hover:bg-red-600 text-white py-1 px-2 rounded-sm text-sm ml-1">Delete</a>
              </div>
              </td>
          </tr>
         <?php endforeach; ?>
